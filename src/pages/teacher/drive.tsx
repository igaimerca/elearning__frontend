...
const FoldersWrapper: React.FC = () => {
    return (
        <div className='bg-white rounded-[8px] mt-2 py-[0.8rem] px-[40px]'>
            <div className='flex justify-between'>
                ...
                <div className='bg-primary-100 w-[30px] h-[30px] flex justify-around items-center rounded-full'>
                    <Image src='/assets/icons/vertical-menu-icon.svg' alt='menu' width={15} height={15} />
                </div>
            </div>

            <div className='flex gap-4 items-center'>
                <div className='items-center justify-between w-[268px] p-[0.8rem] flex gap-[19px] border-[#F0F0F0] border-[1px] rounded-[8px] mt-[19px]'>
                    <div className='flex gap-4'>
                        <Image src='/assets/icons/docs-icon.svg' width={15} height={15} alt='item' />
                        <label className='text-[0.8rem] text-[#454545]'>Ap English II</label>
                    </div>
                    <div>
                        <Image src='/assets/icons/vertical-gray-menu-icon.svg' alt='menu' width={15} height={15} />
                    </div>
                </div>

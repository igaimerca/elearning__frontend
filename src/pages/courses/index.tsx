        ...
        <div className='bg-white mt-1 rounded-xl '>
            <div className='p-4 flex justify-end mr-[15em]'>
                <Tab
                    ...
                    activeBorder={false}
                    options={{
                        tabContainerClassName: 'w-full p-2 bg-primary-100 flex rounded-xl  justify-between w-9/12',
                        tabItemClassName: 'cursor-pointer flex items-center text-gray-500 text-[18px] text-neutral-600 px-5 py-3',
                        activeTabClassName: 'text-primary bg-white px-5 py-3 rounded-xl text-[18px] '
                    }}
                />
            </div>
        </div>
...
const CoursesList: React.FC = () => {
    ...
    return (
        <div className='p-[40px] bg-white mt-1 rounded-xl'>
            ...
            <div className='grid grid-cols-3 gap-[2em] mt-[20px]'>
...
const CourseItem: React.FC<ICourseItemProps> = ({ title, description, primaryColor, baseColor, date }) => {
    return (
        <div className='w-[330px] rounded-[8px]' style={{ boxShadow: '0px 2px 2px rgba(79, 98, 182, 0.08), 0px 5px 5px rgba(169, 185, 255, 0.13)' }}>

...
import { getNavParentItems, getOtherNavParentItems } from '~/components/molecules/sidebar/items'

export default function MainLayout({ children }: {children: React.ReactNode}) {
    return (
        <div className='flex overflow-x-hidden overflow-y-hidden'>
            <nav className='w-[16%] h-[100vh] top-0 sticky'>
                <Sidebar getNavItems={getNavParentItems} geOtherNavItems={getOtherNavParentItems}/>
            </nav>
